function [ConvertedData,ConvertVer,ChanNames,GroupNames,ci]=convertTDMS(SaveConvertedFile,filename,dataloc)
...
for fnum=1:numel(infilename)
    ...
    if SaveConvertedFile
        ...
        MATFileNameLong=fullfile(dataloc,MATFileNameShort);
        try
...
switch LVType
    ...
    case 11  %tdsTypeExtendedFloat
        matType='double'; %changed from 10*char
